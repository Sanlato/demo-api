package com.sanlato.demo.exceptions;
...
protected ResponseEntity<Object> handleMethodArgumentNotValid(
    ...
    WebRequest request) {
        ErrorResponse errorResponse = new ErrorResponse(
            ...
            for 
        (FieldError fieldError : methodArgumentNotValidException.getBindingResult().getFieldErrors())
 {
 ...
 return ResponseEntity.unprocessableEntity().body(errorResponse);
     ...
     public ResponseEntity<Object> handleAllUncaugthException(
        Exception exception,
        WebRequest request) {
...
public ResponseEntity<Object> DataBindingViolationException(
 ...
 private ResponseEntity<Object> buildErrorResponse (
  ...
  HttpStatus httpStatus,
WebRequest request){
                ErrorResponse errorResponse = new ErrorResponse(httpStatus.value(), massage);
